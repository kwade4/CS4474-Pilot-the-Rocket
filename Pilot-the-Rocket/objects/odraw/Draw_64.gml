...
draw_sprite_ext(s_GameHUD, 0, 522, 700, 0.50, 0.50, 0, -1, 1);
...
//Same every time -> Altitude box 
draw_sprite_ext(sAltitudeHUD, 0, 120, 662, 0.60, 0.60, 0, -1, 1);
//Same every time -> Number box 1
draw_sprite_ext(sNumberBox, 0, 150, 710, 0.55, 0.55, 0, -1, 1);
//Same every time -> Number box 2
draw_sprite_ext(sNumberBox, 0, 305, 710, 0.55, 0.55, 0, -1, 1);
//Same every time -> Number box 3
draw_sprite_ext(sNumberBox, 0, 640, 710, 0.55, 0.55, 0, -1, 1);
//**Add to rocket Object -> altitude
draw_text(190, 730,"MAX")
//**Add to rocket Object -> x velocity
draw_text(350, 730,global.fuel)
//**Add to rocket Object -> y velocity
draw_text(695, 730,global.fuel)
